...
create_clock -add -name i2c_clk -period 10.00 -waveform {0 5} [get_pins {i2c_clk}]; #I2C clk 
...
##Buttons
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { i_pbutton[0] }]; # BTNC
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { i_pbutton[1] }]; # BTNU
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { i_pbutton[2] }]; # BTNL
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { i_pbutton[3] }]; # BTNR
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { i_pbutton[4] }]; # BTND
...
## I2C pins FPGA
set_property -dict { PACKAGE_PIN K14 IOSTANDARD LVCMOS33 } [get_ports { i2c_scl }];
set_property -dict { PACKAGE_PIN K13 IOSTANDARD LVCMOS33 } [get_ports { i2c_sda }];
